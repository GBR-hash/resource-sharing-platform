...
import com.example.resourcesharingplatform.security.JwtAccessDeniedHandler;
import com.example.resourcesharingplatform.security.JwtAuthenticationEntryPoint;
import com.example.resourcesharingplatform.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/favorites/my").authenticated()
