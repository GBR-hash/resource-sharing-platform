  ...
  <div class="auth-page">
    ...
    <div class="auth-card auth-card--wide">
      <div class="auth-card__header">
        ...
        <p class="auth-card__subtitle">创建账号，开启资料共享之旅</p>
      </div>
...
import { FolderOpened, User, Message, Lock, Phone } from '@element-plus/icons-vue'
...
@media (max-width: 768px) {
  ...
  .auth-card { width: 90%; max-width: 360px; padding: 24px 18px 20px; border-radius: 16px; }
  .auth-card__logo { width: 52px; height: 52px; border-radius: 14px; }
